...
namespace DotNetAppSqlDb.Controllers
{
    public class TodosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Name,Email,PhoneNumber,Salary,Position,CreatedDate")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Name,Email,Position,PhoneNumber,Salary,CreatedDate")] Todo todo)
        {
